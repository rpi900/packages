...
Pre-built packages are available&ndash;follow [these instructions](../#package-repository). This is recommended for must users, since building the kernel package can be tedious!
